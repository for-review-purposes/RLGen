...
class TestSum(unittest.TestCase):
    ...
    def test_various(self):
        ...
        i+=1
        self.takeStep(action = 3,
            stActionExp = 8, stateExp = [0,1.5], # No reset, part of trascedental.
        ...
        i+=1
        self.takeStep(action = 0,
            stActionExp = 1, stateExp = [-1,1.5], 
            ALExp = [[1,3],[0]], SLExp = [[4,8],[1]], runExp = 1, 
            rewardExp = -0.7, 
            cumRewardExp = -0.25,
            doneExp = False,
            ID = i, choice = 1)
        i+=1
        self.takeStep(action = 2,
            stActionExp = 6, stateExp = [0,1.5], 
            ALExp = [[1,3],[0,2],[]], SLExp = [[4,8],[1,6],[]], runExp = 2, 
            rewardExp = 0.7, 
            cumRewardExp = 0.45,
            doneExp = True,
            ID = i, choice = 6)
        ...
        i+=1
        self.takeStep(action = 1,
            stActionExp = 4, stateExp = [-1,1.5], 
            ALExp = [[0,3],[1]], SLExp = [[0,9],[4]], runExp = 1, 
            rewardExp = -0.4, 
            cumRewardExp = -0.25,
            doneExp = False,
            ID = i, choice= 4)
        ...
        self.takeStep(action = 2,
            ...
            ALExp = [[0,3],[1]], SLExp = [[0,9],[4]], runExp = 1, 
            rewardExp = self.inFeasiblePenalty, 
            cumRewardExp = -0.25 + self.inFeasiblePenalty,
            doneExp = True, #on the basis of failure
            ID = i, choice= 7)
        ...
        i+=1
        self.takeStep(action = 1,
            stActionExp = 5, stateExp = [-3,1], 
            ALExp = [[0,2],[1]], SLExp = [[0,6],[5]], runExp = 1, 
            rewardExp = -3.2, 
            cumRewardExp = -1.8,
            doneExp = True, # Dead-end
            ID = i, choice = 5)
        i+=1
        self.takeStep(action = 2,
            stActionExp = -1, stateExp = [-3,1], 
            ALExp = [[0,2],[1]], SLExp = [[0,6],[5]], runExp = 1, 
            rewardExp = self.inFeasiblePenalty, 
            cumRewardExp = -1.8 + self.inFeasiblePenalty,
            doneExp = True,
            ID = i, choice = 7)
        ...
        i+=1
        self.takeStep(action = 2,
            stActionExp = -1, stateExp = [-5,0], 
            ALExp = [[0]], SLExp = [[2]], runExp = 0, 
            rewardExp = self.inFeasiblePenalty, 
            cumRewardExp = - 3.5 + self.inFeasiblePenalty,
            doneExp = True,
            ID = i, choice= 6)
        i+=1
        self.takeStep(action = 2,
            ...
            ALExp = [[0]], SLExp = [[2]], runExp = 0, 
            rewardExp = self.inFeasiblePenalty, 
            cumRewardExp = - 3.5 + 2*self.inFeasiblePenalty,
            doneExp = True,
            ID = i, choice= 5)
        i+=1
        self.takeStep(action = 2,
            ...
            ALExp = [[0]], SLExp = [[2]], runExp = 0, 
            rewardExp = self.inFeasiblePenalty, 
            cumRewardExp = - 3.5 + 3*self.inFeasiblePenalty,
            doneExp = True,
            ID = i, choice= 7)
...
## 
        ...
        self.takeStep(action = 2,
            ...
            cumRewardExp = -0.25 + self.env.inFeasiblePenalty,
            doneExp = True,
            ID = i, choice= 7)
